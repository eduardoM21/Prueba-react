...
function App() {
  const futbolista = [
    {
      imgPrincipal:
        "https://www.fcbarcelonanoticias.com/uploads/s1/11/84/73/7/leo-messi-en-una-imagen-de-archivo-2_4_641x361.jpeg",
      jugador: "Leonel Messi",
      parrafo:
        "Lionel Andrés Messi Cuccittini, conocido como Leo Messi ​ es u futbolista argentino que juega como delantero o centrocampista.Hadesarrollado toda su carrera en el F.C.Barcelona de la Primera División de España y en la selección de Argentina equipos de los que e      capitán",
      title: "X6",
      imgbalon:
        "https://www.mundodeportivo.com/r/GODO/MD/p6/Barca/Imagenes/2019/12/02/Recortada/3ef3fe6193554e4996154d144f5cfc51-k0bC-U472022470741EqC-980x554@MundoDeportivo-Web.jpg",
      imgclub: "http://assets.stickpng.com/images/584a9b3bb080d7616d298777.png",
      seleccion:
        "https://cdn.ligadegamers.com/imagenes/escudo-argentina-dls.jpg",
    },
    {
      imgPrincipal:
        "https://www.ecestaticos.com/image/clipping/7f9859887bc693e63a5edc2b9e3bb8a6/el-supuesto-cambio-de-planes-de-la-juventus-para-evitar-la-detencion-de-cristiano-ronaldo.jpg",
      jugador: "Cristiano Ronaldo",
      parrafo:
        "Cristiano Ronaldo dos Santos Aveiro, GOIH, ComM​​​, más conocido como Cristiano Ronaldo, es un futbolista portugués que juega como delantero en la Juventus F. C. de la Serie A de Italia y en la selección de Portugal, de la cual es su capitán",
      title: "X5",
      imgbalon:
        "https://elpais.com/deportes/imagenes/2017/12/08/actualidad/1512731536_228620_1512737833_noticia_fotograma.jpg",
      imgclub:
        "http://as00.epimg.net/img/comunes/fotos/fichas/equipos/large/29.png",
      seleccion:
        "https://i.pinimg.com/originals/a0/68/0e/a0680e656be35d50484060701fb1535b.png",
    },
  ];
  return (
    <div>
      {futbolista.map((jugador) => {
        return <Jugador key={jugador.title} {...jugador} />;
      })}
    </div>
  );
}
